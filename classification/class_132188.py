# -*- coding: utf-8 -*-
"""
GSE132188 - Classification (4-class) - v1

- Inputs from GSE132188/processed/GSE132188_DeepLineage_all_generated_*
- Variable-length training by UpTo_* and All_*
- Base models: BiLSTM / RNN / Transformer
- Stacking: LogisticRegression
- Outputs: per-setting ROC, macro ROC across settings, performance trend, 3D PCA of probabilities
"""
...
class Config:
    ...
    out_dir: str = "/Users/wanghongye/python/scLineagetracer/classification/GSE132188"
    model_dir: str = ""  # auto
...
def load_data(cfg: Config):
    ...
    if labels is None:
        if label_h5 is None:
            raise KeyError(f"Missing labels in both CSV ({cfg.csv_label_col}) and H5 (label_str)")
        labels = label_h5
